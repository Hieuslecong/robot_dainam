...
// Tunables
// ---------------------------------------------------------------------------
const $490ce42ff92ff39b$var$MAX_DEPTH = 10;
const $490ce42ff92ff39b$var$MAX_NODES = 200;
const $490ce42ff92ff39b$var$MAX_CHILDREN_PER_NODE = 50;
const $490ce42ff92ff39b$var$NAME_MAX = 100;
...
const $490ce42ff92ff39b$var$MAX_SELECT_OPTIONS = 20;
...
// `<ui_state>` injection.
const $490ce42ff92ff39b$var$SELECTION_TEXT_MAX = 2000;
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
const $490ce42ff92ff39b$var$refMap = new WeakMap();
const $490ce42ff92ff39b$var$WeakRefCtor = typeof WeakRef === "undefined" ? undefined : WeakRef;
const $490ce42ff92ff39b$var$refToElement = new Map();
let $490ce42ff92ff39b$var$refCounter = 0;
...
function $490ce42ff92ff39b$export$b09bfb5aa97446d5() {
    $490ce42ff92ff39b$var$refCounter = 0;
    $490ce42ff92ff39b$var$refToElement.clear();
}
// ---------------------------------------------------------------------------
// Inclusion / exclusion
// ---------------------------------------------------------------------------
const $490ce42ff92ff39b$var$EXCLUDED_TAGS = new Set([
    "script",
    "style",
    "link",
    "meta",
...
// Role derivation
// ---------------------------------------------------------------------------
const $490ce42ff92ff39b$var$INTERACTIVE_ROLES = new Set([
    "button",
    "link",
    "checkbox",
    "radio",
...
const $490ce42ff92ff39b$var$LEAF_ROLES = new Set([
...
// ---------------------------------------------------------------------------
function $490ce42ff92ff39b$var$collapseWhitespace(s) {
    return s.replace(/\s+/g, " ").trim();
}
function $490ce42ff92ff39b$var$truncate(s, max = $490ce42ff92ff39b$var$NAME_MAX) {
    const collapsed = $490ce42ff92ff39b$var$collapseWhitespace(s);
...
function $490ce42ff92ff39b$var$getName(el, role) {
    ...
    if (tag === "input" || tag === "textarea" || tag === "select") {
        ...
        if (id) {
            ...
            for(let i = 0; i < labels.length; i++){
                if (labels[i].htmlFor === id && labels[i].textContent) return $490ce42ff92ff39b$var$truncate(labels[i].textContent ?? "");
            }
        }
    ...
    if (tag === "img") {
        ...
        return alt ? $490ce42ff92ff39b$var$truncate(alt) : undefined;
    }
    ...
    if ($490ce42ff92ff39b$var$LEAF_ROLES.has(role) || role === "paragraph") {
        ...
        return text ? $490ce42ff92ff39b$var$truncate(text) : undefined;
    }
    return undefined;
}
...
function $490ce42ff92ff39b$export$e702c6c416f7c8de() {
    ...
    if (active instanceof HTMLInputElement || active instanceof HTMLTextAreaElement) {
        ...
        if (start !== null && end !== null && start !== end) {
            const ref = $490ce42ff92ff39b$var$refMap.get(active);
            if (!ref) return null;
...
class $4a4f32f44a93ea38$export$d1b25383c8328718 {
    ...
    emit() {
        ...
        if (!this.running) return;
        try {
            const snapshot = (0, $490ce42ff92ff39b$export$326b5f56ac5b6149)(undefined, {
...
class $db6391dc7d757577$export$78e1011ee1942cf6 extends $db6391dc7d757577$export$59b4786f333aac02 {
    constructor(message){
...
const $c0d10c4690969999$export$7bdaf0e0d661a8f5 = "2.0.0";
...
class $364c127d152b1085$export$8f7f86a77535f7a3 extends $364c127d152b1085$var$RTVIEventEmitter {
    ...
    get selectedCam() {
        try {
            ...
            if (e instanceof $db6391dc7d757577$export$bd0820eb8444fcd9) {
    ...
    enableCam(enable) {
        try {
            ...
            if (e instanceof $db6391dc7d757577$export$bd0820eb8444fcd9) this._options.callbacks?.onUnsupportedFeature?.(e);
            else throw e;
        }
    }
    get isCamEnabled() {
